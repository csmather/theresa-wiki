...
Monkey built it. He says it's his *magnum opus*. It is not so much *in* the library as the library is now, structurally, part of *it* — built into the building the way a church organ is built into a church: pipes through the walls, bellows under the floorboards, one repurposed bubble wand performing a function I have been assured is critical. Whisper a question into the tube — your own words, half-formed is fine ("why do opposites attract in the psyche?") — and somewhere in the walls, "important machinery" comes to life, and the pages your question was *really* about will come rattling back, smelling faintly of brass and bananas, even the ones that never use your words at all. I have asked Monkey how this doohickey works. He showed me the clipboard. There is still nothing on the clipboard.

For the record, Bunny insists I add a practical note, and Bunny is right to insist: first, your browser must take delivery of the machine — a ~25 MB installation, once. Monkey will hand you some paperwork to sign, though I think he really just wants your autograph.
