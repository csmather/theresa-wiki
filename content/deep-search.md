...
Monkey built it. Permission is pending. It is not so much *in* the library as the library is now, structurally, part of *it* — built into the building the way a church organ is built into a church: pipes through the walls, bellows under the floorboards, one repurposed bubble wand performing a function I have been assured is critical. Whisper a question into the tube — your own words, half-formed is fine ("why do opposites attract in the psyche?") — and somewhere below, the machinery goes *whump*, and the pages your question was really about come rattling back, smelling faintly of brass and banana, even the ones that never use your words at all. I have asked what happens between the whisper and the *whump*. He showed me the clipboard. There is still nothing on the clipboard.
